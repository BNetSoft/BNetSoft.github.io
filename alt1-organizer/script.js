...
function findPlayers(minimapRegion) {
    ...
    for(let i = 0; i <res.length; i++){ 
        ...
        alt1.overLayLine(a1lib.mixcolor(255, 0, 0, 255), 2, posx-3, posy-3, posx+3, posy+3, 300);
        alt1.overLayLine(a1lib.mixcolor(0, 255, 0, 255), 2, posx+3, posy-3, posx-3, posy+3, 300);
    }
    return res.length;
}
